 ...
 *
 * <p>This class is a thin delegate: every {@link RocketmqEvent} call is forwarded
 * to the wrapped event. The Spring source ({@link #getSource()}) returns the
 * delegate itself, which preserves identity with the underlying
 * {@code RocketmqEvent}.</p>
 *
 * <p>Lives in the spring module — {@code core} stays free of Spring.</p>
 *
